...
- Hiện tại cty thằng a tui là làm về xây dựng nhưng mà thích ứng dụng công nghệ vào đấy để tối ưu sản xuất
...
- Thằng a tui là dân xây dựng nhưng lại thích code nên h ổng đang gánh về mảng code tool cho cái xây dựng này,
...
- Giờ cty ni nó có cái vấn đề chính là :
  ...
  - Thứ 2 là xử lý trích xuất dữ liệu bản vẽ tự động => bản vẽ khách hàng nó gửi cũng dầm cột các kiểu mà cách bố trí thông số mỗi khách nó lại mỗi khác giờ họ muốn làm như nào đó để build model hay dựng tool gì đó để nó tự động detect đúng dữ liệu họ cần lấy cho dù input nó định dạng như nào (này là best practice, còn đợt tui làm giúp thằng a tui là mỗi loại bản vẽ tui code 1 tool thực ra thì có vài file python à :v)
- Tb vào thì chủ yếu lo 2 vấn đề trên còn việc code c++ với c# để làm với mấy tool autocad thì mảng này thằng a tui làm hoặc sau này từ từ học thoải mái

## Pros

- H mà tb gật đầu cái thì 80% là vào làm luôn tại thằng a tui là người tuyển trực tiếp với tb sau sẽ làm việc trực tiếp với thằng a tui
...
- Vô đây thì chỉ có bạn với thằng a tui gánh mảng IT của cty ni
